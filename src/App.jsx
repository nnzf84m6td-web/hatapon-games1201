...
const CARDS = [
  ...
  { id:"c12", name:"闇の竜王 バハムート",        emoji:"🐉",  atk:35, weakness:["c8"],           fatigue:false, color:["#1a0533","#4c1d95"], symbol:"♜", pattern:"blades",  label:"DRAGON" },
  { id:"c13", name:"海神の巫女 ルミア",          emoji:"🌊",  atk:14, weakness:["c12"],          fatigue:false, color:["#0c4a6e","#1d4ed8"], symbol:"⚓", pattern:"waves",   label:"SEA" },
  { id:"c14", name:"雷神の化身 ライコウ",        emoji:"⚡",  atk:25, weakness:["c9"],           fatigue:false, color:["#713f12","#ca8a04"], symbol:"↯", pattern:"rays",    label:"THUNDER" },
  { id:"c15", name:"聖騎士 アルトリウス",        emoji:"🛡️",  atk:18, weakness:["c14"],          fatigue:false, color:["#1e3a5f","#4338ca"], symbol:"✙", pattern:"diamonds",label:"KNIGHT" },
  { id:"c16", name:"砂漠の狐 フェンリル",        emoji:"🦊",  atk:13, weakness:["c15"],          fatigue:false, color:["#78350f","#d97706"], symbol:"⋯", pattern:"dots",    label:"BEAST" },
  { id:"c17", name:"氷結の魔導師 フリーズ",      emoji:"❄️",  atk:17, weakness:["c7"],           fatigue:false, color:["#0e7490","#06b6d4"], symbol:"❋", pattern:"stars",   label:"ICE" },
  { id:"c18", name:"毒霧の暗殺者 シャドウ",      emoji:"🗡️",  atk:22, weakness:["c17"],          fatigue:false, color:["#1c1917","#292524"], symbol:"†", pattern:"circuit", label:"SHADOW" },
  { id:"c19", name:"大地の守護者 ゴーレム",      emoji:"🪨",  atk:16, weakness:["c14"],          fatigue:false, color:["#44403c","#78716c"], symbol:"◉", pattern:"grid",    label:"EARTH" },
  { id:"c20", name:"森の精霊 シルヴァン",        emoji:"🌿",  atk:11, weakness:["c18"],          fatigue:false, color:["#14532d","#15803d"], symbol:"✿", pattern:"dots",    label:"NATURE" },
  { id:"c21", name:"天空の聖獣 グリフィン",      emoji:"🦅",  atk:23, weakness:["c17"],          fatigue:false, color:["#1e40af","#7c3aed"], symbol:"♅", pattern:"rays",    label:"SKY" },
  { id:"c22", name:"炎獄の魔王 イフリート",      emoji:"😈",  atk:30, weakness:["c13"],          fatigue:false, color:["#7f1d1d","#b91c1c"], symbol:"⁂", pattern:"flames",  label:"DEMON" },
  { id:"c23", name:"機械神 オメガ",              emoji:"⚙️",  atk:28, weakness:["c3"],           fatigue:false, color:["#1f2937","#374151"], symbol:"Ω", pattern:"circuit", label:"MACHINE" },
  { id:"c24", name:"星読みの占師 セレナ",        emoji:"🔮",  atk:9,  weakness:["c22"],          fatigue:false, color:["#2e1065","#6d28d9"], symbol:"★", pattern:"stars",   label:"ORACLE" },
  { id:"c25", name:"嵐の海賊王 ドレイク",        emoji:"⚓",  atk:19, weakness:["c21"],          fatigue:false, color:["#0f172a","#0369a1"], symbol:"⚓", pattern:"waves",   label:"CORSAIR" },
  { id:"c26", name:"死霊術師 ネクロス",          emoji:"💀",  atk:21, weakness:["c8"],           fatigue:false, color:["#0f172a","#4b5563"], symbol:"☽", pattern:"blades",  label:"NECRO" },
  { id:"c27", name:"黄金の勇者 ジークフリート",  emoji:"🏆",  atk:26, weakness:["c22"],          fatigue:false, color:["#713f12","#ca8a04"], symbol:"♞", pattern:"diamonds",label:"WARRIOR" },
  { id:"c28", name:"水晶の魔女 クリスタル",      emoji:"💎",  atk:15, weakness:["c14"],          fatigue:false, color:["#0e7490","#7c3aed"], symbol:"◆", pattern:"rays",    label:"CRYSTAL" },
  { id:"c29", name:"猛毒の蛇神 ヴァイパー",      emoji:"🐍",  atk:18, weakness:["c21"],          fatigue:false, color:["#14532d","#166534"], symbol:"∿", pattern:"wind",    label:"VENOM" },
  { id:"c30", name:"破壊神 ダークマター",        emoji:"🌑",  atk:38, weakness:["c24"],          fatigue:true,  color:["#030712","#1e1b4b"], symbol:"●", pattern:"stars",   label:"VOID" },
  { id:"c31", name:"風の剣聖 カゼマル",          emoji:"🌪️",  atk:16, weakness:["c19"],          fatigue:false, color:["#0f766e","#0891b2"], symbol:"⊛", pattern:"wind",    label:"BLADE" },
  { id:"c32", name:"炎竜 フレアドラゴン",        emoji:"🔥",  atk:27, weakness:["c13"],          fatigue:false, color:["#7f1d1d","#ea580c"], symbol:"≋", pattern:"flames",  label:"FLARE" },
  { id:"c33", name:"霧の幻術師 ミスト",          emoji:"🌫️",  atk:12, weakness:["c14"],          fatigue:false, color:["#334155","#475569"], symbol:"∞", pattern:"dots",    label:"ILLUSION" },
  { id:"c34", name:"鋼鉄の番人 ガーディアン",    emoji:"🤺",  atk:14, weakness:["c32"],          fatigue:false, color:["#1e293b","#334155"], symbol:"⊕", pattern:"grid",    label:"GUARD" },
  { id:"c35", name:"光明の天使 ルシエル",        emoji:"👼",  atk:24, weakness:["c26"],          fatigue:false, color:["#78350f","#ca8a04"], symbol:"☀", pattern:"rays",    label:"ANGEL" },
  { id:"c36", name:"深淵の魚人 アビサル",        emoji:"🐙",  atk:17, weakness:["c35"],          fatigue:false, color:["#0c4a6e","#1e3a5f"], symbol:"∮", pattern:"waves",   label:"ABYSS" },
  { id:"c37", name:"業火の巨人 ヴォルカノ",      emoji:"🌋",  atk:29, weakness:["c13"],          fatigue:false, color:["#7c2d12","#b91c1c"], symbol:"△", pattern:"flames",  label:"VOLCANO" },
  { id:"c38", name:"時空の旅人 クロノス",        emoji:"🕰️",  atk:20, weakness:["c30"],          fatigue:false, color:["#312e81","#1d4ed8"], symbol:"⊗", pattern:"grid",    label:"CHRONO" },
  { id:"c39", name:"聖なる弓使い アルテミス",    emoji:"🏹",  atk:13, weakness:["c18"],          fatigue:false, color:["#14532d","#4338ca"], symbol:"⌖", pattern:"dots",    label:"ARCHER" },
  { id:"c40", name:"無限の魔神 アブソリュート",  emoji:"♾️",  atk:45, weakness:["c24","c3"],     fatigue:true,  color:["#0f172a","#312e81"], symbol:"∅", pattern:"circuit", label:"ABSOLUTE" },
];
